...
const SkillCloud = ({ showInfo }) => {
  ...
  const skills = [
    { name: "React", level: 11, size: "large", position: { lg: { top: "11%", left: "78%" }, md: { top: "11%", left: "78%" }, sm: { top: "9%", left: "74%" }, xs: { top: "15%", left: "66%" } }},
    ...
    { name: "JavaScript", level: 9, size: "large", position: { lg: { top: "38%", right: "42%" }, md: { top: "38%", right: "42%" }, sm: { top: "39%", right: "38%" }, xs: { top: "47%", right: "25%" } }},
    ...
    { name: "Node.js", level: 8, size: "medium", position: { lg: { bottom: "32%", right: "49%" }, md: { bottom: "33%", right: "36%" }, sm: { bottom: "21%", right: "38%" }, xs: { bottom: "14%", right: "51%" } }},
    ...
    { name: "Typescript", level: 0, size: "medium", position: { lg: { bottom: "56%", left: "26%" }, md: { bottom: "60%", left: "25%" }, sm: { bottom: "7%", left: "35%" }, xs: { bottom: "49%", left: "76%" } }},
