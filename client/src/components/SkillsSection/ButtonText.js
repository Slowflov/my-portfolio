...
const ButtonText = ({ onClick }) => {
  ...
  return (
    <div className="flex items-center justify-center">
      <button 
        className={`relative min-w-[100px] min-h-[20px] lg:min-w-[180px] lg:min-h-[40px] md:min-w-[180px] md:min-h-[40px] sm:min-w-[180px] sm:min-h-[30px] xs:min-w-[200px] xs:min-h-[50px] flex items-center justify-center text-center font-semibold text-[#313133] 
